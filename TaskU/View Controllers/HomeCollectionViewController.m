...
//  TaskU
//
//  Created by rhaypapenfuzz on 7/18/19.
...
static NSString * const reuseIdentifier = @"HomeCollectionViewCell";

- (void)viewDidLoad {
    [super viewDidLoad];
    
    categories = @[@"Logo", @"get_coffee"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell
    cell.categoryImages.image = [UIImage imageNamed:categories[indexPath.row]];
